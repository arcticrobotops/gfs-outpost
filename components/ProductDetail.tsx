...
export default function ProductDetail({
  ...
  const safeShopifyUrl = shopifyUrl && shopifyUrl.startsWith('https://') ? shopifyUrl : null;
          ...
          <div className="px-4 py-3 flex flex-wrap gap-2">
            {variants.map((v) => (
              <button
                ...
                className={`font-data text-xs tracking-wider px-4 py-2 min-h-[44px] min-w-[44px] border transition-colors duration-150 ${
