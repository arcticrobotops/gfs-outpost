      ...
      <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-10 sm:pb-14 md:pb-16 px-4 text-center">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="font-data text-[11px] tracking-[0.3em] text-copper uppercase">
          ...
          <div className="mt-6">
            <a
              href="#inventory"
              className="inline-block font-data text-[11px] tracking-[0.25em] uppercase px-8 py-3 border-[2px] border-linen/40 text-linen hover:bg-linen/10 transition-colors duration-200"
            >
              Browse Inventory
            </a>
          </div>
