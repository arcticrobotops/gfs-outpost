          ...
          <div className="space-y-6">
            ...
            {product.onlineStoreUrl && (
              <a
                ...
                className="block w-full bg-forest text-linen font-data text-[11px] tracking-[0.25em] uppercase text-center py-4 border-[2.5px] border-forest hover:bg-copper hover:border-copper transition-colors duration-200"
              >
                Requisition
              </a>
            )}
